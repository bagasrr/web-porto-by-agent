  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-12 md:py-20">
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
        {/* Profile Image */}
        <div className="w-64 h-64 md:w-80 md:h-80 relative brutal-border brutal-shadow-lg bg-accent-red overflow-hidden">
          <Image src="/images/profile.jpg" alt={profile?.fullName || "Profile"} fill className="object-cover" priority />
        </div>

        {/* Hero Text */}
        <div className="text-center md:text-left">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-[family-name:var(--font-space-mono)] leading-tight">{profile?.heroTitle || "I Build Things For The Web."}</h1>
          <div className="mt-6">
